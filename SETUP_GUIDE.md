# Enterprise Policy Copilot — Complete Setup Guide
...
7. You should see messages like:
   ```
   Database Enterprise_Copilot created.
   Table Accounts created successfully.
   Table AuditTrail created successfully.
   ...
   === Enterprise_Copilot database setup complete ===
   ```
...
```
INFO | Enterprise Policy Copilot backend starting up…
...
You should see the **Enterprise Policy Copilot login screen**.
