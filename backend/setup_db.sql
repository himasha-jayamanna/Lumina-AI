-- ============================================================
--  Enterprise Policy Copilot – MSSQL Database Setup Script
...
IF NOT EXISTS (
    SELECT name FROM sys.databases WHERE name = N'Enterprise_Copilot'
)
BEGIN
    CREATE DATABASE Enterprise_Copilot;
    PRINT 'Database Enterprise_Copilot created.';
END
ELSE
BEGIN
    PRINT 'Database Enterprise_Copilot already exists – skipping creation.';
END
GO

USE Enterprise_Copilot;
GO
...
PRINT '=== Enterprise_Copilot database setup complete ===';
